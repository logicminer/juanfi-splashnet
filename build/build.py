...
def patch_login(html: str, city: str, env_type: str, cluster: str, sdk_base: str) -> str:
...
def main() -> None:
    ...
    (args.dst / "login.html").write_text(
        patch_login((args.dst / "login.html").read_text(), args.city, args.env_type, args.cluster, args.sdk_base)
    )
